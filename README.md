...
| `SupportsColor`        | This property adds block controls which allow the user to change the block’s text and background color.                                                                                                                                                               | `true`  or `false` | _optional_ (defaults to `false`)      |
